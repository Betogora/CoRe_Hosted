...
test("login gate exposes the supported authentication paths without an app session", async ({ page }) => {
  await page.goto("/");
...
test("invalid credentials stay behind the login gate and show the German auth error", async ({ page }) => {
