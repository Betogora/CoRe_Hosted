...
function normalizeGeneratedTypes(value: string) {
  return `${String(value).replace(/\r\n/g, "\n").trimEnd()}\n`;
}

function generateDatabaseTypes(): Promise<string> {
...
export async function synchronizeDatabaseTypes({ mode = "check" }: { mode?: "check" | "write" } = {}) {
