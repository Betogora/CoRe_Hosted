...
- Die Statistik ist ein lazy geladener, kanonischer Analysepfad mit einer globalen Zeitraum- und hierarchischen Mehrfach-Stapelauswahl. Sie projiziert Aktivität, Lernzeit und Messabdeckung, die gemeinsame responsive Lern-Heatmap, Planung, Bestand, Intervalle, FSRS-Verteilungen, Antwortverhalten, wahre Erinnerungsquote, Stapelvergleich und schwierige Karten aus einem gemeinsamen indexierten Modell. Sortierte Ereignisreihen werden binär auf den Zeitraum begrenzt; eine einzige ersetzbare Scope-Ableitung beschleunigt wiederholte Filterwechsel ohne wachsenden Cache. Diagrammreihen bleiben auf höchstens 240 Punkte begrenzt, die Heatmap speichert nur aktive Tageszähler und materialisiert das sichtbare Wochenfenster, und Detailaktionen verwenden die bestehende Navigation.
