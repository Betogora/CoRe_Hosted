...
- Review mit vier Bewertungen, echtem FSRS-6 auf offiziellen Standardparametern, Tastatursteuerung und deterministischer Intervallvorschau. Eltern-, Kind- und Enkelbudgets begrenzen gemeinsam eine Baumrunde; beim direkten Unterstapelstart gelten nur dessen aktiver Teilbaum und Reviews reservieren das gemeinsame Budget vor neuen Karten. Intraday-Lernschritte umgehen Limits, Interday-Lernschritte verbrauchen Reviewbudget. Der gestartete Stapel bestimmt die Sortierung neuer Karten nach Alter oder stabilem Lerntagszufall sowie fälliger Karten nach Überfälligkeit oder tatsächlicher Abrufwahrscheinlichkeit. Der accountweite Tagesbeginn und das Vorziehfenster bleiben DST-sicher; durch Limits verborgene Karten werden am Start und Abschluss verständlich ausgewiesen. Easy Days verteilt neu berechnete Reviewintervalle von 3 bis 90 Tagen innerhalb des offiziellen FSRS-Fensters anhand der Last aller aktiven Stapel. FSRS-Stabilität, Schwierigkeit und gewünschte Erinnerungsrate bleiben unverändert.
...
- Globale Einstellungen und Stapeleinstellungen besitzen je drei responsive Bereichskarten und direkte Quernavigation. Global liegen nur Konto/Datenschutz, Tagesbeginn, Vorziehfenster, der siebentägige Wochenrhythmus, Fokuswerkzeuge und Daten/Sync; Tageslimits, Sortierung, weitere Schedulerwerte und CoRe bleiben stapelspezifisch. Die decklose Stapeleinstellungsroute bietet eine echte Stapelauswahl.
