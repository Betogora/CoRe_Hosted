...
| `src/libraryModel.ts` | Reine Projektionen für Stapelhierarchie, unbegrenzte gruppierte Kartentabelle einschließlich Fälligkeits-/Variantenstatus und Sortierung, Suche und Dashboard-Tageszähler für die gemeinsame Heatmap |
