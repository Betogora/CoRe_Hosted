...
- Interaktiv angelegte oder verschobene Stapelbäume besitzen höchstens acht sichtbare Ebenen: Hauptstapel plus sieben Unterebenen. Ein zu tiefes Ziel wird ohne Mutation mit `Maximal acht Stapel-Ebenen sind möglich.` abgelehnt.
