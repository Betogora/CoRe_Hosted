...
- Erstellen-Screen mit history-stabiler Vorauswahl fuer manuelle Erstellung oder Import, den bestehenden Einstiegskacheln und einer reloadfesten Abschlussbestaetigung mit `Jetzt lernen` und `Karten prüfen`; manuelle Kartenerstellung mit optionaler PDF-/Textquelle, Anki-artig untereinander angeordneter Vorder- und Rueckseite, Pinnfunktion, Rich-Text-Editor und bestehendem/neuem Stapelziel.
