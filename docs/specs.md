...
- `Neue Karten pro Tag` und `Reviews pro Tag` werden ausschließlich in den Stapeleinstellungen bearbeitet und nicht in den Lerneinstellungen angeboten. Eine Änderung des Neulimits hebt einen alten Tages-Override auf.
