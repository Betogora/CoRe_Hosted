...
- Unter `Einstellungen → Lernen → Globale Lernvorgaben` steht nahe `Lernkarten vorziehen` ausschließlich accountweit `Neuer Tag beginnt um [Zahl] Stunden nach Mitternacht`. Das native Zahlenfeld akzeptiert ganze Stunden von 0 bis 23; die Einheit steht außerhalb des Felds. Der Standard 0 erhält Mitternacht als Tagesgrenze. Bei 3 gehört 02:59:59 noch zum Vortag und um 03:00 beginnt der neue fachliche Lerntag. Die Einstellung wird weder in Stapel kopiert noch von Lernprofil-Presets verändert.
...
- Der Beginn des fachlichen Lerntags ist eine accountweite Lernvorgabe von 0 bis 23 ganzen Stunden nach Mitternacht und wird über Profil-Sync sowie Export und Import transportiert.
