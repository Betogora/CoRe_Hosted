...
- `Heute`, `Lernen` und `Kartenverwaltung` verwenden dieselben Stapeldaten mit Tiefenfarbe, Chevron, Icon, Kennzahlen, Fortschrittsdonut und Drei-Punkte-Aktion. Die Zeile zeigt bei jeder Breite ausschließlich den einzeiligen, bei Überlänge elliptisch gekürzten Stapelnamen und niemals den Hierarchiepfad; die sichtbaren Kennzahllabel erscheinen erst ab 44 rem tatsächlich verfügbarer Zeilenbreite. Der vollständige Pfad und die Kennzahlbedeutungen bleiben zugänglich. Dashboard und Lernen zeigen Teilbaum-Kennzahlen; in der Kartenverwaltung beziehen sich Kennzahlen und Donut ausschließlich auf die direkten Karten des jeweiligen Stapels.
