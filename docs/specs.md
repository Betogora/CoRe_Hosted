...
- Die beiden Methodeneinträge im Einstieg sind als Abschnittsnavigation bedienbar. Beide oberen Linien bleiben im Ruhezustand dünn; nur der mit Maus oder Tastatur fokussierte Eintrag erhält kräftigere Schrift und eine stärkere obere Linie. Beide Einträge scrollen mit derselben Dauer in einer deutlich wahrnehmbaren Bewegung zu ihrer Methodenüberschrift; bei reduzierter Bewegung erfolgt der Wechsel unmittelbar. Auf dem Weg zu `Spaced Repetition` wird der Höhenbereich der drei Active-Recall-Unterschritte in einem einzigen Sprung übersprungen, damit Anfang und Ende der Bewegung sichtbar bleiben, ohne die Unterschritte nacheinander abzuspielen.
