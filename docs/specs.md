...
- `Karte bearbeiten` öffnet den Einzelkarten-Editor. Flagge, Markieren, Aussetzen, Pomodoro und Kartenreihenfolge sind sichtbar als noch nicht verfügbar gekennzeichnet und mutieren nichts. Kartenverwaltung, Reset, Mischen und `Nur normale Karten` sind nicht Bestandteil der Lerneinstellungen.
