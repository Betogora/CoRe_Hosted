...
- Umbenennen, normales und variantenfokussiertes Lernen sowie Löschen sind ausschließlich in den Stapel-Einstellungen erreichbar. Unterstapel können dort mit vorausgewähltem Elternstapel oder über die Ebenenauswahl des dauerhaften Schnellformulars in Lernen angelegt werden. Nach einer von den Einstellungen gestarteten Sitzung führt der Rückweg zum URL-reproduzierbaren Ursprung.
