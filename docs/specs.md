...
- Unter `Globale Einstellungen → Lerntag & Fokus` stehen accountweit der Tagesbeginn von 0 bis 23 Uhr, das Vorziehfenster von 0 bis 720 Minuten und der siebentägige Wochenrhythmus. Der Tagesbeginn 0 erhält Mitternacht als Grenze; bei 3 gehört 02:59:59 noch zum Vortag und um 03:00 beginnt der neue fachliche Lerntag. Das Vorziehfenster gilt für Queue und laufende Sitzung aller Stapel, ist standardmäßig 20 Minuten und wird durch 0 deaktiviert. Easy Days verwenden `Normal`, `Weniger` und `Minimal` und verändern keine bestehenden Termine. Diese Werte werden weder in Stapel kopiert noch von Lernprofilen verändert.
