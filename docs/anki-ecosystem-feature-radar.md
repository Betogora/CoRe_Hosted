...
| Scheduler-Korrektheit und Desired Retention | [FSRS im Handbuch](https://docs.ankiweb.net/deck-options.html#fsrs), FSRS4Anki, per-Deck Desired Retention in Anki 25.09 | FSRS-6 mit offiziellen Standardparametern vorhanden | Mit echten Reviewhistorien kalibrieren und persönliche Parameteroptimierung erst mit ausreichender Datengrundlage ergänzen |
