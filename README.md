...
- Fullscreen-Review mit Antwortaufdeckung, vier Ratings (`Again`, `Hard`, `Good`, `Easy`) und Tastatursteuerung.
...
src/
  ...
  reviewService.js        Review-Sessions und Rating-Erfassung
  scheduler.js            Review-Intervalle und Maturity-XP
  coreVariantService.js   Eligibility, Rephrase-Varianten und Varianten-Feedback
...
- `specs.md`: Produktvision, Anforderungen, Datenmodell, API-Skizzen, Architektur und Implementierungsstand.
- `specs.html`: navigierbare HTML-Fassung der Spezifikation.
- `todo.md`: Differenz zwischen aktuellem lokalen MVP und produktionsreifem Zielbild.
...
- Produktionspfad fuer Hosting, Persistenz, Auth und KI-Jobs entscheiden.
