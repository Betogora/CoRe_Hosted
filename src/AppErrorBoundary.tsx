...
export function AppErrorFallback({ info = APP_RUNTIME_INFO, onReload, onOpenHome }: any) {
  return (
    <main className="min-h-screen bg-core-canvas p-4 text-core-text sm:p-8">
      <div className="grid min-h-[calc(100vh-2rem)] place-items-center rounded-[22px] border border-core-border bg-core-surface px-5 py-10 shadow-[var(--core-shadow-raised)] backdrop-blur-xl sm:min-h-[calc(100vh-4rem)]">
