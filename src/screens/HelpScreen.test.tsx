...
test("renders scroll stories for active recall and spaced repetition", () => {
  ...
  assert.match(markup, /h-\[22rem\][^>]*transform:translateX\(-30px\) scaleX\(0\.94\)/);
  assert.match(markup, /h-\[20\.5rem\][^>]*transform:translateX\(-12px\) scaleX\(0\.97\)/);
  ...
  assert.match(markup, /<a(?=[^>]*href="#spaced-repetition-heading")(?=[^>]*data-help-method-navigation="direct")/);
