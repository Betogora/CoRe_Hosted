...
- `DecksScreen.jsx`: deck library, filtering, parent/child hierarchy, rename, drag-and-drop reparenting, CoRe mode controls, card editor and variant prompt UI; opened from the Learn header.
...
- `LearnScreen.jsx`: collapsible deck tree, subtree study entry points, new/due/total counts and deck options.
