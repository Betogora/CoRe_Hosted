...
- `GlobalCardSettingsScreen.tsx`: vier sichtbare Bereiche der `Lerneinstellungen` für accountweiten Lerntag/Planung, Tagesrunde/Lernprofile, Scheduler/CoRe und Fokuswerkzeuge; der globale Stapelstandard bleibt von allgemeinen Konto-Einstellungen und lokalen Stapeleinstellungen getrennt.
