...
- `AppNavigation` aus `src/ui/AppNavigation.tsx`: einzige responsive App-Navigation. Unter 1280 px besitzt sie den kompakten CoRe-Kopf, optionalen Pomodoro-Fortschritt, Einstellungszahnrad und die schwebende Fünf-Tab-Bottom-Bar; ab 1280 px die Sidebar mit demselben Fortschritt oberhalb der Einstellungstrennlinie. `Mehr` projiziert direkt die Kartenverwaltung, während Einstellungen, Hilfe und Simulator eine Utility-Gruppe bilden.
